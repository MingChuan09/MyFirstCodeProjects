...
def main():
	"""
	To draw Sierpinski Triangle by recursion.
	"""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	...
	:param upper_left_x: the coordinate x of the triangle
	:param upper_left_y: the coordinate y of the triangle
	"""
	if order == 0:
		return
	else:
		...
		right_line = GLine(upper_left_x+length*0.5, upper_left_y+length*0.866, upper_left_x+length, upper_left_y)
		window.add(up_line)
